    ...
    <div className="flex flex-col gap-4 py-10">
      <section className="rounded-3xl border border-white/10 bg-white/5 px-8 py-10">
        <div className="flex flex-col gap-1 text-left">
          <div className="flex items-center gap-2 text-xl font-semibold text-amber-400 md:text-3xl">
            <MessageCircleWarning className="h-8 w-8" />
            Payment cancelled.
          </div>
          <div className="text-base text-white/70">
            Your payment was cancelled. You can retry the checkout whenever you are ready.
          </div>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-4">
        <Card className="border-white/10 bg-dark-gray text-white">
          <CardHeader>
            ...
            <CardDescription className="text-white/60">
              Review the order details before retrying your payment.
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <Card className="border-white/10 bg-dark-gray text-white">
            <CardHeader>
              ...
              <CardDescription className="text-white/60">
                We&apos;ll use these details after payment is completed.
              </CardDescription>
            </CardHeader>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="text-sm text-white/60">
            Ready to try again? We&apos;ll hold your order details for the retry.
          </div>
...
export default PaymentCancelledContent;
