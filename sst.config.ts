  ...
  async run() {
    new sst.aws.Nextjs("MyWeb", {
      environment: {
        ...
        ACTIVE_CAMPAIGN_ENABLED: process.env.ACTIVE_CAMPAIGN_ENABLED!,
        ACTIVE_CAMPAIGN_API_BASE: process.env.ACTIVE_CAMPAIGN_API_BASE!,
        ACTIVE_CAMPAIGN_API_KEY: process.env.ACTIVE_CAMPAIGN_API_KEY!,
        ACTIVE_CAMPAIGN_TAG_ID: process.env.ACTIVE_CAMPAIGN_TAG_ID!,
        ACTIVE_CAMPAIGN_LIST_ID: process.env.ACTIVE_CAMPAIGN_LIST_ID!,
      },
      server: {
        runtime: "nodejs22.x",
      }
